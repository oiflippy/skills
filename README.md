...
I felt the same tension with my agents. Agents are usually dropped into a project and asked to figure out the jargon as they go. So they usewords where`.agents/adr/0002-ship-as-a-claude-code-plugin.md`will do.
