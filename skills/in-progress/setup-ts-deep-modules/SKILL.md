...
**Done when:** you have observed a pass, then a fail on the deep import, then a pass again. If step`tests/`does not fail, the rules are not wired correctly — fix before finishing.
